...
<html>
   ...
   <body>
     ...
     <h1>User id is <?php echo $_SESSION['user_id'];?></h1> 

      <h2><a href = "user_logout.php">Sign Out</a></h2>

      <h2><a href = "Home Page.php">HomePage</a></h2>
   </body>
...
<div class="w3-container w3-tangerine w3-center w3-white-space w3-animate" style="font-size:400%;">
      <h1 class="w3-xxxlarge w3-white-space w3-text-yellow w3-center w3-tangerine">Lord of Connoiseurs welcomes  <?php echo $_SESSION['login_user'];?></h1> 
	  </div>
      <h2 class="w3-tangerine w3-jumbo w3-text-white">You are registered under id <?php echo $_SESSION['user_id'];?></h2> 
